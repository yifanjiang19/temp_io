...
p.innerHTML = '<strong>Yifan Jiang*</strong>, Xiaoye Qu*, <a href="https://oyxhust.github.io/">Xi Ouyang</a>, <a href="https://sites.google.com/site/chengyu05/">Yu Cheng</a>, Shiping Wen, Yang Yang, Pan Zhou';
dom1.innerText = "";
dom1.appendChild(p);

dom2 = dom.childNodes[1].childNodes[1].childNodes[3].childNodes[3].childNodes[7];
var p = document.createElement('p');
p.innerHTML = '<a href="https://oyxhust.github.io/">Xi Ouyang*</a>, <a href="https://sites.google.com/site/chengyu05/">Yu Cheng*</a>, <strong>Yifan Jiang</strong>, <a href="http://www.cs.cmu.edu/~chunlial/">Chun-Liang Li</a>, Pan Zhou';
dom2.innerText = "";
dom2.appendChild(p);
