...
dom1 = dom.childNodes[1].childNodes[1].childNodes[3].childNodes[1].childNodes[5];
dom1.innerText = "Yifan Jiang*, Xiaoye Qu*, Xi Ouyang, Yu Cheng, Shiping Wen, Yang Yang, Pan Zhou";